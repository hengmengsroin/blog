...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/hengmengsroin/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/hengmengsroin/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/hengmengsroin/blog/blog/comments/{id}
   */
  queryComments = (
    id: string,
    query?: {
    ...
    this.request<BlogQueryCommentsResponse, RpcStatus>({
      path: `/hengmengsroin/blog/blog/comments/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/hengmengsroin/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/hengmengsroin/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/hengmengsroin/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryPostsResponse, RpcStatus>({
      path: `/hengmengsroin/blog/blog/posts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
